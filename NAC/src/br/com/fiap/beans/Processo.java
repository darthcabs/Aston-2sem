...
public class Processo {
	 ...
	 * @param taxa
	 */
	public Processo(long numero, Cliente cliente, Causa especialidade, List<Honorario> honorario, Forum forum,
			List<Despesa> despesa, String descricao, String dataAbertura, String dataFechamento, String dataVencimento,
			int resultado, int situacao, String observacao, Taxa taxa) {
		this.numero = numero;
